...
mod tests {
    ...
    fn cell_positions_of_line_60() {
        ...
        let data = fs::read_to_string("../fixtures/lr_physics_grid/grid_60_tests.json")
    ...
    fn cell_positions_of_line_61() {
        ...
        let data = fs::read_to_string("../fixtures/lr_physics_grid/grid_61_tests.json")
            .expect("Failed to read JSON file");
        run_grid_tests(grid, data);
    }
    ...
    fn cell_positions_of_line_62() {
        ...
        let data = fs::read_to_string("../fixtures/lr_physics_grid/grid_62_tests.json")
            .expect("Failed to read JSON file");
        run_grid_tests(grid, data);
    }
}
