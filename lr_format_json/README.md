...
Created for linerider.com. LRA implemented a compatible serializer for the legacy version. However, while the linerider.com format structure received updates, the LRA implementation did not catch up to these updates. Additionally, LRA added support for LRA-native features, diverting the initial format.
...
```js
{
  ...
  "linesArray"?: [ // Legacy line array format, not in current web version
    // line type
    // id
    // x1, y1, x2, y2
